...
import { Text, View, Image, StyleSheet, TouchableOpacity, Modal, TouchableHighlight, ScrollView, TouchableWithoutFeedback } from 'react-native';
...
export default class Launches extends React.Component {
  ...
  render() {
    ...
    const launches = this.state.launches.map(launch => {
      return(
        <TouchableWithoutFeedback key={launch.flight_number} onPress={() => {
          this.setState({
